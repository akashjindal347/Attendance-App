...
class _LoginPageState extends State<LoginPage>
  ...
  Widget _buildSignIn(BuildContext context) {
    ...
    Future<Map<String, dynamic>> Login(String email, String password) async {
      ...
      final http.Response response = await http.post(
          'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyDzhDqanWOy7-GOyCgoi8NjN9bMSp40Fbc',
  ...
  Future<Map<String, dynamic>> _submitForm() async {
      ...
      print(_emailValue);
       Map<String, dynamic> user = {'email': _emailValue, 'password': _passwordValue};
      http.Response response = await http.post(
          'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyDzhDqanWOy7-GOyCgoi8NjN9bMSp40Fbc',
          body: json.encode(user),
          headers: {'Content-Type': 'application/json'});
          print(response.body);
    }
